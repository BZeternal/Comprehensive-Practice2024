<template>
    <div style="display: flex;flex-wrap: wrap;justify-content: center;">
        ...
        <div v-if="userStore.state == '审核中'"
            style="width: 100%;height: 50px;font-size: 20px;color: rgb(255, 217, 0);text-align: center;">当前信息正在审核中</div>
        <el-card style="width: 60%;margin-bottom: 20px;" v-if="userStore.auth == 2 && userStore.state != '非学员'">
        ...
        <el-card style="width: 60%;" v-if="userStore.auth == 2 && userStore.state != '非学员'">
